...
[Ahrefs]: https://web.archive.org/web/20240130212256/https://ahrefs.com/blog/discovered-currently-not-indexed/

[Ahrefs] has a post on the topic. For pigweed.dev I suspect that the issue is
related to how we've configured redirects.

## Update 2 (30 Jan 2024)

[Redirect error]: https://web.archive.org/web/20240130213440/https://support.google.com/webmasters/answer/7440203#multiple_redirects
...
of a redirect issue. The **LEARN MORE** link points me to [Redirect error].

![Google Search Console > URL Inspection](/assets/gsc-redirect.png)
