...
description: >
  ...
  night of experimentation appears to be a resounding "maybe"!
---
...
I wanted to show you this because this is the exact text that the models see.

Now let's rig this bad <strike>boy</strike> extension up to do some
summarization...
...
of course there's all the licensing uncertainty around generated content.
