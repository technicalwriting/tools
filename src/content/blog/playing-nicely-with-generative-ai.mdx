...
(I am focused on using generative AI to help the users of your docs get their
...
the need to disambiguate these "generative AI for docs" discussions.)
...
* Small docs will probably play more nicely with generative AI than large docs.
  ...
  into small sections of logically related content.
...
questions about your domain (without providing domain-specific context)
