...
(Throughout this post I use the term **docs SSGs** to refer to the static
site generators (SSGs) that most documentation websites are built on top
of: Docusaurus, Jekyll, Sphinx, and so on. This idea also applies to docs
content management systems like Wordpress, readme.io, and so on.)
