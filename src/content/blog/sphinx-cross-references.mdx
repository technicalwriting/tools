...
title: >
  The curious case of the super helpful Sphinx feature that is strangely lacking
  from other docs sites
...
description: >
  ...
  toil. Why is this approach not more common in other docs sites?
---

<p>{frontmatter.description}</p>

(Throughout this post I use the term **docs sites** to refer to the static
site generators (SSG) and content management systems (CMS) that most
documentation websites are built on top of: Docusaurus, Jekyll, Sphinx,
Wordpress, docsify, MkDocs, readme.io, and so on.)
...
## Problems with how most docs sites approach link text

In most docs sites, you have to manually create and maintain the link text.
...
is strangely lacking in many docs sites! But, alas, I will have to save that
...
the [IfThisThenThat] one that the Fuchsia codebase uses.
...
## The status of this feature in other docs sites

[If I wasn't so lazy] I would list out the exact status of this feature on
other docs sites. I am not going to do that, however, because, as previously
alluded to, I am lazy. I don't mean to imply that this feature is not supported
on any other doc site. I am sure there is some other docs site out there that
has "seen the light." From what I can tell, though, Sphinx has the best built-in
